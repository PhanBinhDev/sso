...
export function GoogleButton({ clientId, redirectUri, state }: Props) {
  async function handleGoogle() {
    ...
    // next = complete-sso absolute URL
    ...
    console.log('redirectTo:', authCallbackUrl.toString()) // ← check
  ...
  return (
    <button
      ...
      className='flex w-full items-center justify-center gap-2 rounded-lg border py-2 text-sm font-medium hover:bg-gray-50'>
      <GoogleIcon />
